...
import ru.liga.oldpictserv.controller.TextEntity;
...
public class CreatePicture {
    ...
    private List<TextEntity> textEntityList = new LinkedList();

    @Autowired
    public CreatePicture(CreatingFont creatingFont, ParseText parseText, CreatingTextLayout creatingTextLayout, CreatingLineBreakMeasurer creatingLineBreakMeasurer) {
